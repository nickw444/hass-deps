...
def install_dependency(config_root_path: str, dependency: Dependency,
    ...
    if not force and lock_info is not None:
        if lock_info.type == 'lovelace':
            ...
            raise AssertionError(
                "Unknown locked dependency type: " + lock_info.type)
    ...
    if lock_info is not None and lock_info.type == 'lovelace' and lock_info.is_release:
        ...
        with checkout_dependency_source(dependency,
            ...
            if is_core:
                rv = install_core_dependency(config_root_path, dependency,
                                               source_path)
            else:
